...
3. **Creating a cleaned csv file**:  I created a cleaned csv file movie_rating_df

3. **Data Visuakization** : I perform some visualization on the train csv to check for the features that affected the rate of transportation on the passengers
